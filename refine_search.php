...
<title>Perfectmate Dating Site -  Sort By Location</title>
...
<b>Showing Users From <?php echo ucfirst($location); ?> ONLY</b> (<a href="/refine_search2.php" class="normal">Show by age instead</a>)</br></br>
<?php
if($gender == "Male"){
    $sex = "Female";
}
